<div class="w-full p-4 shadow-lg overflow-x-auto sticky top-0 bg-white z-10">
...
<div class="viewfood flex flex-wrap gap-y-4  my-4 justify-between items-center">
    <div class="bg-[#e3e3e3]  flex flex-col w-[48%]  flex justify-center items-center p-2 rounded-xl">
        <img class="w-[80%]  h-[100px]"
            src="https://static.vecteezy.com/system/resources/thumbnails/036/303/390/small_2x/ai-generated-steaming-coffee-cup-hot-beverage-illustration-transparent-background-coffee-mug-clipart-hot-drink-graphic-brewed-coffee-icon-cafe-latte-png.png"
            alt="">
        <p class="text-right w-full">برگر</p>
        <p class="text-right w-full">200 تومان</p>
    </div>
