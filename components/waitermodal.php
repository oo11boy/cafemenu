<div id="waiter-modal" class="hidden p-4 yekan fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-[999]">
    <div class="bg-white p-5 rounded-xl shadow-lg text-center">
        ...
        <button id="submit-request" class="bg-green-500 text-white px-4 py-2 rounded">ارسال درخواست</button>
        <button id="close-modal" class="bg-red-500 text-white px-4 py-2 rounded mt-2">بستن</button>
    </div>
</div>